...
Each of these applications is available as an example in the "RailsApps GitHub repo":https://github.com/oleksandrbyk and each is accompanied by a tutorial on the "Capstone Rails Tutorials":https://tutorials.railsapps.org/ site.
...
Problems? Please check "issues for the Rails Composer tool":https://github.com/oleksandrbyk/olek-rails-composer/issues.
...
Daniel Kehoe initiated the "RailsApps project":https://github.com/oleksandrbyk. The "rails_apps_composer":https://github.com/RailsApps/rails_apps_composer gem is derived from Michael Bleigh’s RailsWizard gem.
